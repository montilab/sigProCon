...
The goal of evalGSVAsig is to identify which genes from a signature are contributing most to a score (e.g., GSVA score).
...
devtools::install_github("montilab/evalGSVAsig")
```
